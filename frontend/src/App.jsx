      ...
      <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mb-12 pb-8 border-b-2 border-[var(--ink)]">
          ...
          <p className="text-[var(--ink-soft)] leading-relaxed max-w-lg">
            Submit a paper (an arXiv link, a direct PDF, or an upload) and a panel of automated referees will check its methodology, hunt for code, and red-pen
        ...
        <footer className="mt-16 pt-6 border-t border-[var(--rule)] font-mono text-xs text-[var(--ink-faint)] text-center">
          SS · Generated by an automated multi-agent reviewer · not a substitute for peer review · SS
        </footer>
      </div>
    </div>
  )
